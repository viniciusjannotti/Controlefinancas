  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-slate-500 dark:text-slate-400 text-lg">Gerencie seu perfil e preferências do sistema.</p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-4">
        ...
        <div className="md:col-span-3 space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-4 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
                ...
                <div>
                  <p className="font-semibold text-slate-900 dark:text-slate-100">{userName || "Usuário"}</p>
            ...
            <CardContent>
              <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
                ...
                >
                  <span
                    className={cn(
                      "absolute top-1 left-1 w-5 h-5 rounded-full bg-white dark:bg-slate-900 shadow-md transition-transform",
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-2">
                <Input
                  ...
                  className="font-mono text-sm bg-slate-50 dark:bg-slate-800/50"
                />
                <Button 
                  variant="outline" 
                  size="icon"
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {loading ? (
                <p className="text-slate-400 dark:text-slate-500 text-sm">Carregando...</p>
              ) : (
                <>
...
function SettingsNavLink({ icon: Icon, label, active = false }: any) {
  return (
    <button className={cn(
      ...
      <ChevronRight className={cn("w-4 h-4", active ? "text-white/70" : "text-slate-400 dark:text-slate-500")} />
    </button>
  );
}
